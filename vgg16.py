...
save_description(descriptions, 'vgg16_desc.txt')
...
dump(features, open('./vgg16_feats.pkl', 'wb'))
...
train_desc = get_clean_descriptions('./vgg16_desc.txt', train_id)
train_features = load_image_features('./vgg16_feats.pkl', train_id)
